...
export default function CarouselAxisSupporting() {
  ...
  return (
    <div className="bg-black container mx-auto py-10 pb-20">
      <div className="mx-auto">
        <h1 className="text-3xl font-bold text-white pb-20">Supporting Organizations</h1>
        <div className="wrapper">
          <div className="scene">
            <div className="carousel keen-slider" ref={sliderRef}>
              <div className="carousel__cell number-slide1 flex justify-center items-center p-4">
                <img src={TampaBayWave} className="max-h-full max-w-full" alt="slide1" />
              </div>
              <div className="carousel__cell number-slide2 flex justify-center items-center p-4">
                <img src={TBTI} className="max-h-full max-w-full" alt="slide2" />
              </div>
              <div className="carousel__cell number-slide3 flex justify-center items-center p-4">
                <img src={VentureLab} className="max-h-full max-w-full" alt="slide3" />
              </div>
            </div>
          </div>
        </div>
